    ...
    <div className="flex gap-3 items-end">
      <div className="flex-1">
        <textarea
          ...
          disabled={disabled}
          rows={1}
          className="w-full px-5 py-3.5 bg-gray-800 border-2 border-gray-700 rounded-2xl focus:border-yellow-500 focus:outline-none focus:ring-2 focus:ring-yellow-500/20 resize-none text-white placeholder-gray-500 transition-all disabled:opacity-50 disabled:cursor-not-allowed"
        />
      </div>
      <button
        onClick={onSend}
