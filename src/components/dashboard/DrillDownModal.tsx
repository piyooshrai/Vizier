...
import { X, Download, Printer, AlertTriangle, Users, TrendingUp, Activity, DollarSign } from 'lucide-react';
import {
  ...
  return (
    <div className="fixed inset-0 bg-black/90 flex items-center justify-center p-4 z-50 overflow-auto">
      <div className="bg-gradient-to-br from-gray-900 to-gray-800 rounded-2xl border border-gray-700 max-w-6xl w-full max-h-[95vh] overflow-auto shadow-2xl">
          ...
          <div className="grid grid-cols-4 gap-3">
            <div className="bg-gray-800/50 border border-gray-700 rounded-xl p-3">
              <div className="flex items-center gap-2 mb-1.5">
                ...
                <span className="text-xs text-gray-400 uppercase tracking-wide">Total Patients</span>
              </div>
              <div className="text-xl font-bold text-white">{data.totalCount.toLocaleString()}</div>
            </div>

            <div className="bg-gray-800/50 border border-gray-700 rounded-xl p-3">
              <div className="flex items-center gap-2 mb-1.5">
                <TrendingUp className="w-3.5 h-3.5 text-gray-400" />
                <span className="text-xs text-gray-400 uppercase tracking-wide">Avg Age</span>
              </div>
              <div className="text-xl font-bold text-white">{data.demographics.avgAge} yrs</div>
            </div>

            <div className="bg-gray-800/50 border border-gray-700 rounded-xl p-3">
              <div className="flex items-center gap-2 mb-1.5">
                <Activity className="w-3.5 h-3.5 text-gray-400" />
                <span className="text-xs text-gray-400 uppercase tracking-wide">Readmission</span>
              </div>
              <div className="text-xl font-bold text-white">{data.metrics.readmissionRate}</div>
            </div>

            <div className="bg-gray-800/50 border border-gray-700 rounded-xl p-3">
              <div className="flex items-center gap-2 mb-1.5">
                <DollarSign className="w-3.5 h-3.5 text-gray-400" />
                <span className="text-xs text-gray-400 uppercase tracking-wide">Avg Cost</span>
              </div>
              <div className="text-xl font-bold text-white">{data.metrics.avgCost}</div>
            </div>
          </div>
        </div>
        ...
        <div className="px-5 pb-5">
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div className="bg-gray-800/50 border border-gray-700 rounded-xl p-4">
              <h4 className="text-xs font-semibold text-gray-300 mb-3">Age Distribution</h4>
            ...
            {/* Gender Split */}
            <div className="bg-gray-800/50 border border-gray-700 rounded-xl p-4">
              <h4 className="text-xs font-semibold text-gray-300 mb-3">Gender Distribution</h4>
              <ResponsiveContainer width="100%" height={220}>
                <PieChart>
                  <Pie
        ...
        {/* Comorbidities */}
        <div className="px-5 pb-5">
          <h3 className="text-sm font-semibold text-white mb-3">Common Comorbidities</h3>
          <div className="bg-gray-800/50 border border-gray-700 rounded-xl p-4">
        ...
        <div className="px-5 pb-5">
          <div className="flex items-center justify-between mb-3">
            <h3 className="text-sm font-semibold text-white">High-Risk Patients</h3>
            <button
                ...
                <table className="w-full">
                  ...
                  <tbody className="divide-y divide-gray-700">
                    {data.highRiskPatients.map((patient) => (
                      <tr key={patient.id} className="hover:bg-gray-800/50 transition-colors">
